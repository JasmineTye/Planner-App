...
export default class newTask extends Component {
  ...
  // addTask() {
  //   axios
  //     .put("http://192.168.1.116:3000/add/task", {
  //       "title" : "Exercising2",
  //       "date" : "16/04/2021",
  //       "timeFrom" : "5:50 PM",
  //       "timeTo" : "6:50 PM",
  ...
  render() {
    ...
    const addTask = () => {
      ...
      // create the post
      axios.post(`${baseURL}/add/task`, requestBody)
        .then((response) => {
    ...
    return (
      <ScrollView>
          ...
          <View style={{ flexDirection: 'row', paddingBottom: 10 }}>
            ...
            <TouchableWithoutFeedback style={styles.timeLabel_1} onPress={showTimeFromPicker}>
              <DateTimePickerModal
                ...
                onConfirm={(date) => {
                  this.setState({
                    timeFrom: moment(date).format('LT')
                  });
                  hideDatePicker();
                }}
        ...
        {
          //    onPress={() => navigation.navigate('Home')} >Confirm</Text>
        }
